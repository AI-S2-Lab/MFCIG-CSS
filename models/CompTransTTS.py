...
from .modules import PostNet, VarianceAdaptor, ConversationalContextEncoder, SemanticInteractionGraph, ProsodyInteractionGraph
...
class CompTransTTS(nn.Module):
    ...
    def __init__(self, preprocess_config, model_config, train_config):
        ...
        self.semantic_interaction_graph = SemanticInteractionGraph()
        self.prosody_interaction_graph = ProsodyInteractionGraph()
    def forward(
        self,
        speakers,
        texts,
        ...
        I_s = self.semantic_interaction_graph(semantic_graph_list)
        I_p = self.prosody_interaction_graph(prosody_graph_list)
